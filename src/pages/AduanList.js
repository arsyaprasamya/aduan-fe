...
const TABLE_HEAD = [
  { id: 'email', label: 'Pelapor', alignRight: false },
...
const AduanList = () => {
  ...
  const handleChangeRowsPerPage = (event) => {
    ...
    setPage(0);
    fetchAduanList(filterName, 0, newRowsPerPage);
  };
  ...
  // const isUserNotFound = filteredAduans.length === 0;
                    ...
                    .map((row) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left">{nama_lembaga}</TableCell>
                          <TableCell align="left">{nama_role}</TableCell>
                          <TableCell align="left">{status}</TableCell>
                          <TableCell align="left">
                            <FontAwesomeIcon icon={faCalendarAlt} />
                            &nbsp;
                            {new Date(waktu).toLocaleDateString('en-US', longDateFormat)}
                            <br />
                            Q:{isian} <br />
                            A:{jawaban || <i>belum di respon</i>} <br />
                          </TableCell>
